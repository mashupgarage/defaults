  ...
  configs: [
    %{
      ...
      checks: [
        ...
        {Credo.Check.Readability.RedundantBlankLines, [exit_status: 4]},
        {Credo.Check.Readability.Semicolons, [exit_status: 4]},
        {Credo.Check.Readability.SinglePipe, []},
        {Credo.Check.Readability.SpaceAfterCommas, [exit_status: 4]},
        {Credo.Check.Readability.StringSigils, []},
        {Credo.Check.Readability.TrailingBlankLine, [exit_status: 4]},
        {Credo.Check.Readability.TrailingWhiteSpace, [exit_status: 4]},
        ...
        #
        {Credo.Check.Consistency.MultiAliasImportRequireUse, [exit_status: 1]},
        {Credo.Check.Design.DuplicatedCode, false},
